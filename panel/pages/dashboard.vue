<template>
  ...
  <div
    id="hs-basic-modal"
    class="hs-overlay pointer-events-none fixed start-0 top-0 z-[60] hidden h-full w-full overflow-y-auto overflow-x-hidden opacity-0 transition-all hs-overlay-open:opacity-100 hs-overlay-open:duration-500">
